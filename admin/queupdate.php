 ...
 <body>
   <?php
    ...
    if (isset($update)) {
      ...
      echo "<h2 class='text-left text-success'>Records updated!</h2>";
      $q = mysqli_query($con, "select * from question where que_id='$id'");
      $res = mysqli_fetch_assoc($q);
    }
   ...
   <form name="form1" method="post" onSubmit="return check();">
     <table class="table table-striped">
       ...
       <tr>
         <td height="26">
           <div align="left"><strong> Enter Question </strong></div>
         </td>
         <td>&nbsp;</td>
         <td><textarea class="form-control" value="<?php echo $res['que_desc']; ?>" name="addque" cols="60" rows="2" id="addque" align="left">
		<?php echo $res['que_desc']; ?>
		</textarea></td>
       </tr>
       <tr>
         <td height="26">
           <div align="left"><strong>Enter Answer 1 </strong></div>
         </td>
         <td>&nbsp;</td>
